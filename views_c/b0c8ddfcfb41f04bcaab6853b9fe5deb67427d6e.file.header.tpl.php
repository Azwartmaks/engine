<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-05 17:44:00
        ...
        <header>
            ...
            <div class="container">
                ...
                <nav class="pull-left top-nav">
                    <ul>  
                        <li><a href="/"<?php if ($_smarty_tpl->tpl_vars['url']->value=='/'||$_smarty_tpl->tpl_vars['url']->value=='index') {?> <?php echo "class='active'";
}?>>Home</a></li>
                        <li><a href="/">About Us</a></li>
                        <li><a href="contact-us.html"<?php if ($_smarty_tpl->tpl_vars['url']->value=='/contact-us') {?> <?php echo "class='active'";
}?>>Contact Us</a></li>
                    </ul>
                </nav>                
                <div class="pull-right">
